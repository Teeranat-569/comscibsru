...
class DelManual extends StatefulWidget {
  const DelManual({Key? key}) : super(key: key);

  @override
  _DelManualState createState() => _DelManualState();
}

class _DelManualState extends State<DelManual> {
  final Stream<QuerySnapshot> _usersStream =
      FirebaseFirestore.instance.collection('manual').snapshots();
  CollectionReference users = FirebaseFirestore.instance.collection('manual');
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: const Text('ลบคู่มือนักศึกษา'),
          ),
          body: Container(
