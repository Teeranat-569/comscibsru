...
class EditCompanyName extends StatefulWidget {
  String docid, position;
  EditCompanyName({Key? key, required this.docid, required this.position})
      : super(key: key);
  @override
  _EditCompanyNameState createState() => _EditCompanyNameState();
}

_EditCompanyNameState createState() => _EditCompanyNameState();

class _EditCompanyNameState extends State<EditCompanyName> {
