...
class Editmore7 extends StatefulWidget {
  String docid, position;
  Editmore7({Key? key, required this.docid, required this.position})
      : super(key: key);
  @override
  _Editmore7State createState() => _Editmore7State();
}

_Editmore7State createState() => _Editmore7State();

class _Editmore7State extends State<Editmore7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text('แก้ไขรายละเอียดเพิ่มเติม'),
