...
class EditMission extends StatefulWidget {
  ...
  EditMission({Key? key, required this.docid, required this.position})
      : super(key: key);
  @override
  _EditMissionState createState() => _EditMissionState();
}
...
class _EditMissionState extends State<EditMission> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text('แก้ไขหน้าที่ความรับผิดชอบ'),
