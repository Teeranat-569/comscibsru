...
class Editmore3 extends StatefulWidget {
  String docid, position;
  Editmore3({Key? key, required this.docid, required this.position})
      : super(key: key);
  @override
  _Editmore3State createState() => _Editmore3State();
}

_Editmore3State createState() => _Editmore3State();

class _Editmore3State extends State<Editmore3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text('แก้ไขคุณสมบัติเพิ่มเติม'),
