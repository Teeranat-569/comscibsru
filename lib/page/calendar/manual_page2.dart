...
import 'pdfpage.dart';
import 'pdfpage2.dart';
import 'pdfpage3.dart';

class ManualPage2 extends StatefulWidget {
  const ManualPage2({Key? key}) : super(key: key);
...
class _ManualPage2State extends State<ManualPage2> {
  ...
  RaisedButton button1() {
    // ignore: deprecated_member_use
    return RaisedButton(
        onPressed: () {
          route(const PdfPage1());
        },
